...
% Name: GBF_example_EFF_path_varspline_lanczos.m
% Test script to compare kernel approximations using Lanczos method
...
% used methods: Lanczos method with different degrees m
...
bf1 = GBF_genGBFeff(G.L,idxW,type1,alpha1,method1);
